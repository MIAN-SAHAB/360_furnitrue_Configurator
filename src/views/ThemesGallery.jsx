...
export const ThemesGallery = ({ onNavigate }) => {
  ...
  if (selectedTheme) {
    return (
      <div className="min-h-screen bg-[#f8f9fb] animate-in fade-in duration-500">
        {/* Preview Header */}
        <header className="bg-white border-b px-8 py-4 sticky top-0 z-[60] flex items-center justify-between shadow-sm">
          ...
          <div className="flex items-center gap-4">
             ...
             <button className="bg-gray-900 text-white px-8 py-3 rounded-2xl font-bold shadow-xl shadow-gray-900/10 hover:bg-black transition-all flex items-center gap-2">
        ...
        <div className="p-8 flex justify-center">
          <div 
            className={`bg-white shadow-2xl rounded-[3rem] overflow-hidden transition-all duration-700 border border-gray-100 ${previewDevice === 'mobile' ? 'w-[375px] h-[750px]' : 'w-full max-w-7xl h-[1200px]'}`}
          >
            <div className="w-full h-full overflow-y-auto custom-scrollbar bg-white">
               ...
               <nav className="p-6 border-b flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-xl tracking-tighter">FURNI.STORE</span>
                  </div>
               ...
               <div className="p-12">
                 <div className="w-full h-[400px] rounded-[3rem] mb-12 flex flex-col items-center justify-center text-center p-12 overflow-hidden relative group" style={{ backgroundColor: selectedTheme.styles.colors[0] }}>
                    <img src={selectedTheme.previewImage} className="absolute inset-0 w-full h-full object-cover opacity-60 mix-blend-overlay" />
                    <h1 className="text-5xl font-bold text-white mb-6 z-10">عنوان البانر الرئيسي</h1>
                    <p className="text-white/80 max-w-xl z-10 leading-relaxed mb-8">هنا يظهر النص التعريفي للمتجر الخاص بك، هذا الثيم صمم ليعرض أثاثك بأفضل شكل ممكن.</p>
                    <button className="px-10 py-4 bg-white text-gray-900 rounded-full font-bold shadow-xl z-10">استعرض الكولكشن</button>
                 </div>
  ...
  return (
    <div className="animate-in fade-in duration-700 bg-[#fcfaf7] min-h-screen">
      {/* Background Decor */}
      <div className="absolute top-0 right-0 w-[40%] h-[600px] bg-teal-500/5 -z-10 rounded-bl-[20rem] blur-[100px]"></div>
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="text-center mb-20 max-w-3xl mx-auto">
          ...
          <h1 className="text-[48px] md:text-[64px] font-bold text-gray-900 mb-6 leading-tight">اختر ثيم متجرك</h1>
        ...
        {/* Filter Bar */}
        <div className="flex flex-col md:flex-row items-center justify-between mb-12 gap-8 sticky top-24 z-40 bg-[#fcfaf7]/80 backdrop-blur-xl p-6 rounded-[2.5rem] border border-white shadow-xl shadow-gray-200/20">
